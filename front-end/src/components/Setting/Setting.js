    ...
    <div className="hidden space-y-6 p-10 pb-16 md:block bg-white">
      ...
      <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0">
        ...
        <div className="flex-1 lg:max-w-2xl">
          ...
          <button className="inline-flex items-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:text-accent-foreground h-9 px-4 py-2 bg-muted hover:bg-muted justify-start">
            Change Password
          </button>
        </div>
      </div>
